...
class ProductController extends Controller
{
    ...
    public function store(StoreProductRequest $request)
    {
        ...
        if ($request->hasFile('product_avatar')) {
            ...
            // Method Upload
            $path = 'uploads/products/product_avatar';
            $imageName = $this->uploadService->uploadImageHandler($file, $productName, $path);
        }
        ...
        // Check Result
        return alertInsert($returnedProduct, 'products.index');
    }
    ...
    public function update(UpdateProductRequest $request, $id)
    {
        ...
        if ($request->hasFile('product_avatar')) {
            ...
            // Upload new file
            $imageName = $this->uploadService->uploadImageHandler($file, $productName, $pathImageAvatar);
        ...
        // Check Result
        return alertUpdate($returnedProduct, 'products.index');
    }
    ...
    public function destroy($id)
    {
        ...
        return alertDelete($result, 'products.index');
    }
}
