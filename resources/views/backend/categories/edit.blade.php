    ...
    <div class="row">
        ...
        <div class="col-lg-4">
            <div class="card card-warning">
                ...
                <!-- /.card-header -->
                <!-- form start -->
                <form action="{{ route('categories.update', $categoryUpdate->id ) }}" method="POST" enctype="multipart/form-data">
                    <div class="card-body">
                        @csrf
                        @method('put')
                        ...
                        <div class="show-image">
                            <img class="w-50" src="{{ asset('uploads/categories') . '/' . $categoryUpdate->image  }}" alt="{{ $categoryUpdate->name }}">
                        </div>
                                            ...
                                            <table class="table table-bordered table-hover table-responsive table-info text-center">
                                                ...
                                                <tbody>
                                                    ...
                                                    <tr>
                                                        ...
                                                        <td><img class="w-100" src="{{ asset('uploads/categories') . '/' . $category->image  }}" alt="{{ $category->name }}">
                                                        </td>
                                                        <td>
